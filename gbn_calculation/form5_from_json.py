...
def forma5_from_json(data_dict):
    ...
    for sheet_name in ["без_подстройки", "с_подстройкой", "по_вчерашнему", "20_тип_дней"]:
        ...
        elif sheet_name == "по_вчерашнему" and data_dict['gbn_for_20_days']:
        ...
        sheet[f'{rmse_with_tweak_col}{rrmse_row}'] = data_dict[way_of_tweak]['rmse_data'][
            'rrmse_with_tweak']
        sheet[f'{rmse_with_tweak_yest_col}{rmse_row}'] = data_dict[way_of_tweak]['rmse_data']['doubled_rmse_with_tweak_yesterday']
        sheet[f'{rmse_with_tweak_yest_col}{rrmse_row}'] = data_dict[way_of_tweak]['rmse_data']['rrmse_with_tweak_yesterday']
